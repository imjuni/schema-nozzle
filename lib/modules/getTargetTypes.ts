...
interface IValidateFileType<T extends IDeleteSchemaOption | TAddSchemaOption> {
  project: tsm.Project;
  option: T;
}

export default function getTargetTypes<T extends IDeleteSchemaOption | TAddSchemaOption>({
  project,
  option,
}: IValidateFileType<T>) {
