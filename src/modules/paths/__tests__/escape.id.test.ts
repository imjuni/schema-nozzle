...
describe('escapeId', () => {
  it('escaped generic name', () => {
    const r01 = escapeId('TSimpleSetOptional<ICategoryDto, "id">', '_');
    const r02 = escapeId('T.-_SimpleSetOptional<ICategoryDto, "id">', '_');
  ...
  it('not escaped name', () => {
    const r01 = escapeId('TSimpleSetOptional', '_');
